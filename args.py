...
def get_parser():
    ...
    # data
    parser.add_argument('--img_path', default='/root/im2recipe-Pytorch/data/images')
    ...
    parser.add_argument('--ingrW2V', default='/root/im2recipe-Pytorch/w2v/vocab.bin',type=str)
    ...
    parser.add_argument('--model_path', default='/root/im2recipe-Pytorch/checkpoints/model_e500_v-8.950.pth.tar', type=str)
    parser.add_argument('--test_image_path', default='/root/im2recipe-Pytorch/chicken.jpg', type=str)    
    ...
    parser.add_argument('--vocab', default = '/root/im2recipe-Pytorch/w2v/vocab.txt', type=str)
